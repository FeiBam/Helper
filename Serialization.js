        ...
        if (TargetKey === MapsKey){
            if (typeof this.Target[MapsKey] === 'object'){
                if (Array.isArray(this.Target[MapsKey])) this.RemoveKey(MapsKey)
                    ...
                    let Child = new ObjectRemove(this.Target[TargetKey],this.Maps[MapsKey],false,this)
                    Child.Main()
        ...
        if (TargetKey === MapsKey){
            ...
            if (typeof this.Target[MapsKey] === 'object'){
                if (Array.isArray(this.Target[MapsKey])) {
                    ...
                    let Child = new ObjectRemove(this.Target[TargetKey],this.Maps[MapsKey],true,this,MapsKey)
                    Child.Main()
                }
            }
